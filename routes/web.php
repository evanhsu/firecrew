...
// ACCOUNTS
        Route::get('/account', array('as' => 'users_index', 'uses' => 'App\Http\Controllers\AccountController@index'));
        Route::post('/account', array('as' => 'register_user', 'uses' => 'App\Http\Controllers\Auth\RegisterController@postRegister'));

        Route::get('/account/me', array('as' => 'edit_user_me', 'uses' => 'App\Http\Controllers\AccountController@editMe'));
        Route::post('/account/me', array('as' => 'update_user_me', 'uses' => 'App\Http\Controllers\AccountController@updateMe'));

        Route::get('/account/{id}', array('as' => 'edit_user', 'uses' => 'App\Http\Controllers\AccountController@edit'));
        Route::post('/account/{id}', array('as' => 'update_user', 'uses' => 'App\Http\Controllers\AccountController@update'));
        Route::post('/account/{id}/destroy', array('as' => 'destroy_user', 'uses' => 'App\Http\Controllers\AccountController@destroy'));

        Route::get('crew/{crewId}/accounts/new', array('as' => 'new_user_for_crew', 'uses' => 'App\Http\Controllers\AccountController@getRegister'));
        Route::post('crew/{crewId}/accounts', array('as' => 'create_user_for_crew', 'uses' => 'App\Http\Controllers\AccountController@postRegisterUserForCrew'));
